    ...
    def make_instance(self, include_optional) -> Subscriptions0DashboardGet200Response:
        ...
        if include_optional:
            return Subscriptions0DashboardGet200Response(
                items = [
                    openapi_client.models._subscriptions_0_dashboard_get_200_response_items_inner._subscriptions_0_dashboard_get_200_response_items_inner(
                        message = '', 
                        image = openapi_client.models._subscriptions_0_dashboard_get_200_response_items_inner_image._subscriptions_0_dashboard_get_200_response_items_inner_image(
                            link = '', 
                            title = '', 
                            img_src = '', ), 
                        type = '', 
